...
define('DB_HOST', 'localhost'); // e.g. sql108.infinityfree.com
define('DB_NAME', 'cshop_local');      // Your vPanel Database Name
define('DB_USER', 'root');            // Your vPanel Username
define('DB_PASS', '');    // Your vPanel Password (Find this in vPanel)

define('SITE_NAME', "Gujju Clothing");

define('SITE_URL', 'http://localhost/i_test');
