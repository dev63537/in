    ...
    <div class="footer-grid">
      ...
      <div class="footer-col footer-brand">
        <a href="<?= SITE_URL ?>/index.php" class="footer-logo">
          <img src="<?= SITE_URL ?>/assets/images/logo.svg" alt="<?= e(SITE_NAME) ?>" style="max-height:45px;width:auto;object-fit:contain;margin-bottom:14px;" onError="if(this.src.indexOf('svg')!=-1){this.src='<?= SITE_URL ?>/assets/images/logo.jpg';}else{this.style.display='none';this.nextElementSibling.style.display='inline-block';}" />
