...
<aside class="admin-sidebar" id="admin-sidebar">
  <div class="admin-brand">
    <img src="<?= SITE_URL ?>/assets/images/logo.jpg" alt="Admin Logo" style="max-height:38px;width:auto;object-fit:contain;" onError="if(this.src.indexOf('assets')!=-1){this.src='<?= SITE_URL ?>/logo.jpg';}else{this.style.display='none';this.nextElementSibling.style.display='inline-flex';}" />
